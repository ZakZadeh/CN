...
parser.add_argument('--datasetName', type=str, default='ballDrop3', help='dataset name: mnist, f_mnist, cifar10, image, ucf101, hmdb51, ballDrop3')
parser.add_argument('--model', type=str, default='resnet3d', help='Neural net model: custom, resnet, custom3D, resnet3d; default=custom')
